        ...
        <div className="order-2 lg:order-none lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:sticky lg:top-24 lg:self-start">
          ...
          <div className="rounded-lg bg-white p-8 shadow-nivel-2 sm:p-10">
            ...
            <a
              ...
              className="centrado-optico mt-8 inline-flex h-12 w-full items-center justify-center gap-2 rounded bg-rojo text-base font-medium text-white transition-colors duration-rapido hover:bg-rojo-700 active:translate-y-px"
            >
