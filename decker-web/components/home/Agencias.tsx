          ...
          <div className="flex flex-col">
            ...
            <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                /* `min-h-11` con margen negativo: crece el área tocable sin
                   empujar la tarjeta de la agencia. */
                className="centrado-optico group -my-2 inline-flex min-h-11 items-center gap-1.5 text-sm font-medium text-negro hover:text-rojo"
              >
                Cómo llegar
                <IconoFlecha className="h-4 w-4 transition-transform duration-medio ease-suave group-hover:translate-x-0.5" />
              </a>
