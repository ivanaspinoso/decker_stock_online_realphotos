...
export default function FormCotizarUsado({ sucursales }: { sucursales: Sucursal[] }) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="centrado-optico inline-flex h-12 w-full items-center justify-center gap-2 rounded bg-rojo text-sm font-medium text-negro transition-colors hover:bg-rojo-700 active:translate-y-px"
      >
