        ...
        <div className="contenedor flex h-full items-center justify-between gap-4">
          ...
          <nav className="hidden items-center gap-1 lg:flex" aria-label="Principal">
            ...
            <a
              ...
              className="centrado-optico ml-4 inline-flex h-11 items-center gap-2 rounded bg-rojo px-6 text-sm font-medium text-negro shadow-[0_2px_12px_rgba(254,199,0,.45)] transition-colors hover:bg-rojo-700"
            >
        ...
        >
          <nav className="contenedor flex flex-col py-3" aria-label="Principal (mobile)">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="centrado-optico mt-5 inline-flex h-12 items-center justify-center gap-2 rounded bg-rojo text-sm font-medium text-negro"
            >
              <IconoWhatsapp className="h-4 w-4" />
